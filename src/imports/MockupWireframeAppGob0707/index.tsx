import svgPaths from "./svg-1fwdm76y2h";
  ...
  return (
    <div className="h-[38px] relative shrink-0 w-[358.002px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[2px] relative size-full">
        <p className="[word-break:break-word] font-['Roboto_Slab:Regular',sans-serif] font-normal leading-[36px] relative shrink-0 text-[#333] text-[24px] whitespace-nowrap">María Valenzuela</p>
      </div>
    </div>
  );
}
...
function Icon() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p19416e00} id="Vector" stroke="var(--stroke-0, #0F5AC4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1243" />
          <path d={svgPaths.p3e059a80} id="Vector_2" stroke="var(--stroke-0, #0F5AC4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1243" />
          <path d="M6.66667 6H5.33333" id="Vector_3" stroke="var(--stroke-0, #0F5AC4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1243" />
          <path d="M10.6667 8.66667H5.33333" id="Vector_4" stroke="var(--stroke-0, #0F5AC4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1243" />
          <path d="M10.6667 11.3333H5.33333" id="Vector_5" stroke="var(--stroke-0, #0F5AC4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.1243" />
        </g>
      </svg>
    </div>
  );
