...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: "Aquí verás avisos urgentes y recordatorios sobre vencimientos, beneficios y otras novedades. Es distinto al buzón de notificaciones oficiales.",
    placement: "bottom",
    requiresHome: true,
  },
  {
    ...
    body: "Accede rápido a documentos, beneficios, notificaciones, sucursales y secciones de tu perfil disponibles en MiGob.",
    placement: "bottom",
    requiresHome: true,
  },
  {
    id: "benefits-shortcut",
    targetId: "tour-benefits-banner",
    title: "Mis beneficios",
    body: "Revisa cupones, subsidios y ayudas activas. Si hay novedades, verás un aviso verde aquí.",
    placement: "bottom",
    requiresHome: true,
  },
  {
  ...
  },
  {
    ...
    body: "Revisa el buzón con notificaciones oficiales de los servicios públicos.",
    placement: "top",
  },
  {
    id: "nav-documents",
  ...
  },
  {
    ...
    title: "Más servicios",
    body: "Mis beneficios, sucursales, pagos al Estado, ClaveÚnica y asistencia están en este menú.",
    placement: "top",
  },
];
