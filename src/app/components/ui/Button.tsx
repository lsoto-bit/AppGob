...
const buttonVariants = cva(
  "inline-flex items-center justify-center tracking-normal transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none",
  {
    variants: {
      ...
      size: {
        sm: "text-xs h-[36px] px-s gap-xs",
        md: "text-xs h-[36px] px-s gap-xs",
        lg: "text-base h-[36px] px-s gap-xs",
        xl: "text-xs h-[48px] px-m gap-xs",
        compact: "text-xs min-h-[36px] px-xs gap-2xs",
        submit: "text-base h-[48px] px-s font-semibold",
        icon: "p-2xs",
        "icon-md": "p-xs",
        "icon-lg": "size-11",
        "icon-circle": "size-8",
    ...
    compoundVariants: [
      ...
      { variant: "secondary", size: "md", class: "text-xs font-medium" },
      { variant: "secondary", size: "lg", class: "text-xs" },
      { variant: "ghost", size: "md", class: "text-xs" },
      { variant: "ghost", size: "compact", class: "text-xs" },
      { variant: "destructive", size: "md", class: "text-xs" },
      ...
      { variant: "chip", size: "md", class: "text-xs" },
      {
        variant: "filter-chip",
        size: "sm",
      ...
      { variant: "select", size: "md", class: "px-s py-s gap-s" },
      { variant: "select", size: "sm", class: "px-s py-xs gap-s rounded-sm" },
