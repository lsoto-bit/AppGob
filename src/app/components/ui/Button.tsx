...
const buttonVariants = cva(
  "inline-flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-30",
  {
    variants: {
      ...
      size: {
        sm: "text-[12px] tracking-[1.2px] px-4 py-2 gap-1.5",
        md: "text-[12px] px-4 py-3 gap-2",
        lg: "text-[16px] px-4 py-3 gap-2",
        xl: "text-[12px] px-5 py-4 gap-2",
        compact: "text-[12px] px-3 py-1.5 gap-1.5",
        submit: "text-[16px] tracking-[1.6px] h-[48px] px-4 font-semibold",
        icon: "p-1",
        "icon-md": "p-1.5",
        "icon-lg": "size-11",
        "icon-circle": "size-8",
        utility: "px-1.5 py-1.5 text-[8px]",
        none: "",
      },
      fullWidth: {
        true: "w-full",
    ...
    compoundVariants: [
      ...
      { variant: "secondary", size: "lg", class: "px-5 py-2.5 text-[12px] tracking-[1.2px]" },
      { variant: "ghost", size: "sm", class: "tracking-widest py-2.5" },
      { variant: "ghost", size: "md", class: "text-[12px] tracking-widest py-3.5" },
      { variant: "ghost", size: "compact", class: "text-[12px] tracking-widest py-2.5" },
      { variant: "destructive", size: "sm", class: "py-2" },
      { variant: "destructive", size: "md", class: "text-[12px] py-2.5" },
      { variant: "link", size: "sm", class: "text-[12px] tracking-widest px-0 py-0" },
      { variant: "link", size: "md", class: "text-[12px] underline px-0 py-0" },
      { variant: "link", size: "none", class: "text-[12px] tracking-widest px-0 py-0" },
      { variant: "inline-cta", size: "none", class: "pt-0.5" },
      ...
      { variant: "secondary", size: "compact", class: "text-[12px] tracking-widest font-bold px-3 py-1.5" },
      {
        variant: "select",
        selected: true,
        class: "border-primary bg-primary text-primary-foreground rounded",
      },
      {
        variant: "select",
        selected: false,
        class: "border-border bg-card active:bg-muted rounded",
      },
