...
import { ArrowLeft, ChevronRight, X, Share2, AlertTriangle, Search, RefreshCw, MapPin, CreditCard, CheckCircle2, Circle, ScanFace } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-foreground/90 flex flex-col items-center justify-center w-full max-w-[390px] mx-auto gap-8">
      <div className="flex flex-col items-center gap-6">
        <div className={`relative w-32 h-32 border-2 flex items-center justify-center transition-all duration-500 ${
        ...
        <div className="text-center">
          ...
          <p className="text-[11px] text-primary-foreground/60 mt-1">
            {state === "scanning" ? "Mire a la cámara para acceder" : "Accediendo al documento…"}
          </p>
        </div>
      </div>
